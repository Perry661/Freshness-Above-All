  ...
  function renderCalendarPage(model, escapeHtml) {
    return `
      <div class="flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        <main data-view-scroll="calendar" class="mx-auto flex min-h-0 w-full max-w-lg flex-1 flex-col gap-6 overflow-y-auto p-4 pb-[calc(10rem+env(safe-area-inset-bottom))]">
